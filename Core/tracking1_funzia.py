...
def is_right_arm_raised(landmarks, w, h):
    try:
        ...
        if (calculate_conversion_distances(right_wrist_px, right_shoulder_px, right_shoulder_px, left_shoulder_px) > ARM_LENGTH) & (right_wrist_px[1] + 50 < right_shoulder_px[1]):  # Range di tolleranza (150 pixel)
            return True
    except IndexError:
        pass
    return False
