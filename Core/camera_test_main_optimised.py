...
try:
    ...
    #         cv2.putText(rgb_image, "Hands on Heart Detected!", (50, 50),
    ...
    #         cv2.putText(rgb_image, "Right arm raised!", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)
    ...
    #     cv2.putText(rgb_image, f"Level: {level}", (50, 50),
    #                 cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0) if level == max_level else (0, 0, 255), 2)

    #     if level == max_level:
    #         cv2.putText(rgb_image, "Max Level Reached!", (50, 100),
    #                     cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 255, 0), 2)

       # Mostra l'immagine risultante
        cv2.imshow("Hand and Body Tracking Detection", rgb_image)
